                        ...
                        <div class="col-md-8 ps-md-4">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="slug" id="slug" class="form-control" placeholder="e.g. health-drinks" value="<?php echo set_value('slug'); ?>" required>
                                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Auto-generate URL Slug from Category Name as they type
