<div class="row mb-4">
    <div class="col-12">
        <h3 class="fw-bold" style="color: var(--dark-sidebar);">Edit Category</h3>
    ...
    <div class="col-12">
        ...
        <div class="card border-0 shadow-sm" style="border-radius: 12px; overflow: hidden;">
            ...
            <div class="card-body p-4">
                <form action="<?php echo base_url('admin/categories/edit/' . $category->id); ?>" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-4 text-center mb-4 mb-md-0 border-end pe-md-4">
                            ...
                            <div class="mb-3 d-inline-block position-relative shadow-sm rounded border" style="width: 150px; height: 150px; overflow: hidden; border: 2px solid var(--primary-gold) !important; background-color: #f9fafb;">
                                <?php
                                $img_src = $category->image ? base_url($category->image) : '';
                                ?>
                                <img id="categoryImagePreview" src="<?php echo $img_src ?: 'https://placehold.co/150x150/1f2937/d4af37?text=No+Image'; ?>" 
                            ...
                            <div class="text-start px-2">
                                <label for="categoryImageInput" class="form-label small fw-semibold text-dark mb-1">Change Image File</label>
                                <input type="file" name="image" id="categoryImageInput" class="form-control" accept="image/png, image/jpeg, image/jpg, image/gif, image/webp">
                        ...
                        <div class="col-md-8 ps-md-4">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" placeholder="e.g. Health Drinks" value="<?php echo set_value('name', $category->name); ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="slug" id="slug" class="form-control" placeholder="e.g. health-drinks" value="<?php echo set_value('slug', $category->slug); ?>" required>
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="status" id="status" class="form-select">
                                        <option value="1" <?php echo set_select('status', '1', (int)$category->status === 1); ?>>Active</option>
                                        <option value="0" <?php echo set_select('status', '0', (int)$category->status === 0); ?>>Inactive</option>
                                    </select>
                                </div>
                            </div>
