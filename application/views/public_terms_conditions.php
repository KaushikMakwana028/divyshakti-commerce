                ...
                <div class="legal-card">
                    ...
                    <div class="mt-5 pt-4 border-top d-flex flex-wrap justify-content-between align-items-center gap-3">
                        <span class="text-muted small">
                            <i class="fa-solid fa-circle-check text-success me-1"></i> Official Regulatory Agreement &bull; Divy Shakti Commerce
                        </span>
                        <div class="d-flex gap-3">
                            <a href="<?php echo base_url('privacy_policy'); ?>" class="text-primary small fw-semibold text-decoration-none">
